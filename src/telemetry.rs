    ...
    N: for<'a> FormatFields<'a> + 'static,
{
    fn format_event(
        ...
        // Severity Mapping (SUTS Standard: UPPERCASE)
        let severity = match *meta.level() {
            tracing::Level::ERROR => "ERROR",
            tracing::Level::WARN => "WARN",
            tracing::Level::INFO => "INFO",
            tracing::Level::DEBUG => "DEBUG",
            tracing::Level::TRACE => "DEBUG", // Trace'i DEBUG olarak normalize ediyoruz
        }.to_string();
        ...
        let event_name = visitor.fields.remove("event")
            ...
            .unwrap_or_else(|| "LOG_EVENT".to_string()); // Fallback
        ...
        let log_record = SutsLogRecord {
            ...
            ts,
            severity,
            tenant_id: "sentiric_demo".to_string(), // Multi-tenant için dinamikleşebilir
